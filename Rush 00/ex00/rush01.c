...
/*   Updated: 2018/11/10 20:41:58 by akharrou         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

int		ft_putchar(char c);

#define TOP_LEFT_CORNER_CHARACTER '/'
#define TOP_RIGHT_CORNER_CHARACTER '\\'

#define BOTTOM_LEFT_CORNER_CHARACTER '\\'
#define BOTTOM_RIGHT_CORNER_CHARACTER '/'
